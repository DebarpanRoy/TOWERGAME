...
function preload() {
  ...
  hexagonImg = loadImage("hexagon (1).png");
...
function setup() {
  ...
  g1 = new Ground(600,285,200,10);
  g2 = new Ground(900, 195, 200, 10);
  g3 = new Ground(750, 600, 1500, 20);
  ...
  hexagon = new Hexagon(55, 190, 30, 30);
...
function draw() {
  ...
  strokeWeight(4);
  textSize(30);
  text("Drag the Hexagon stone and Release it,to launch it towards the blocks", 80, 50);
  pop();
  ...
  imageMode(CENTER);
  image(hexagonImg, ball.position.x, ball.position.y, 40,60);
